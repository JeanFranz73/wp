<?php
/*
Plugin Name: Desativar atualizações
Description: Desativa as atualizações do WordPress, a verificação de atualização de temas, plug-ins e o sistema de notificação.
Version:     padrão
Author:      Jean Franz
Author URI:  https://facebook.com/JeanFranz.dev
*/
...
class OS_Disable_WordPress_Updates {
	...
	function __construct() {
		...
		/* Desativar atualizações de temas em versões WordPress 2.8 a 3.0 */

		add_filter( 'pre_transient_update_themes', array($this, 'last_checked_atm') );


		/* Desativar atualizações de temas a partir da versão 3.0 do WordPress */

		add_filter( 'pre_site_transient_update_themes', array($this, 'last_checked_atm') );


		/* Desativar atualizações de plug-ins em versões WordPress 2.8 a 3.0 */

		add_action( 'pre_transient_update_plugins', array($this, 'last_checked_atm') );


		/* Desativar atualizações de plug-ins a partir da versão 3.0 do WordPress */

		add_filter( 'pre_site_transient_update_plugins', array($this, 'last_checked_atm') );


		/* Desativar atualizações do Core em versões WordPress 2.8 a 3.0 */

		add_filter( 'pre_transient_update_core', array($this, 'last_checked_atm') );


		/* Desativar atualizações do Core a partir da versão 3.0 do WordPress */

		add_filter( 'pre_site_transient_update_core', array($this, 'last_checked_atm') );


		/* Filtrar verificações de agendamento */
		/* Importante revisar: */
		...
		/* Desativar todas as atualizações automáticas a partir da versão 3.7 do WordPress */
